    ...
    <div id="RegistrationBox" >
     <div id="box1">
        ...
        <form @submit.prevent="FormSubmit" > 
            ...
            <div id="FieldsInput" >
               <input placeholder="Enter your name " name="Name" type="text" id="FieldsInput" v-model="name"  > </input>
               <input placeholder="Enter your email " name="Email" type="email" id="FieldsInput" v-model="email" > </input>
               <input placeholder="Enter your reg " name="Reg" type="text" id="FieldsInput" v-model="reg" > </input>
               <input placeholder="Enter your phone number " name="Phone" type="tel" id ="FieldsInput"  v-model="phone" > </input>
               <input placeholder="Enter your gender" name="Gender" type="text" id ="FieldsInput" v-model="gender"> </input> 
               <input placeholder="Enter your message" name="Message" type="text" id ="FieldsInput"  v-model="message"> </input>
               <div>
